...
# describes the function build-FTAudit
Describe 'build-FTAudit' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { build-FTAudit } | Should Not Throw
    }
    It 'does something' {
      # call function build-FTAudit and pipe the result to an assertion
      # Example:
      # build-FTAudit | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      build-FTAudit | Should BeNullOrEmpty 
    }
  }
}
