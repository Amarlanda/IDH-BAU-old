...
$base[0..10] = $(Import-Clixml -Path "C:\Amar\vmdata.xml")
$ADbase[0..50] = $(Import-Clixml -Path "C:\Amar\ADObjects.xml")

build-FTAudit -BaseArray $ADbase[0..50] -VMwareArray $base[0..10]